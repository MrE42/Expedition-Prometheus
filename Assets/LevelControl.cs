...
{
    public List<List<int>> waves = new List<List<int>> { new List<int> {1}, new List<int> {2}, new List<int> {1,2}, new List<int> {2,2}, new List<int> {3}, new List<int> {1,3}, new List<int> {1,2,3}, new List<int> {1,1,3,3}, new List<int> {1,1,1}, new List<int> {1}}; // each index is an array were [num of enemy 1, num of enemy 2, num of enemy 3]
